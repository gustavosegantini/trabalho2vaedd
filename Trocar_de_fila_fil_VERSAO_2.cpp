    ...
    while( 1 ){
        ...
        switch(opcao){
            ...
            case 2: // VAZIA OU REMOVE ELEMENTO
                ...
                break;
            case 3: // VAZIA OU REMOVE ELEMENTO
                if (estaVazia(&umaQueue) && estaVazia2(&umaQueue2)){
                    printf("\n Fila vazia!!!\n\n");
                }
                else {
                    ...
                    if (x == 1) {
                        float j;
                        //A intenção era que o valor digitado seria removido dessa
                        //fila, em seguida j seria adicionado no topo da outra fila
                        //mas nao funcionou, por isso foi removido da proxima versão,
                        //assim como a ideia do PID
                        printf("\n Qual Valor?");
                        scanf("%f", &j);
                        j = remover(&umaQueue);
                        printf("\n%0.2f removido com sucesso\n\n", j) ;
